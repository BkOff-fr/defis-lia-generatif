...
pub use model_presets::{
    available_models, available_models_filtered, find_preset, ArchitectureKind, CalibrationStatus,
    ModelFamily, ModelPreset, Openness, VendorDisclosure, VendorScope, VendorUnit, VisionPricing,
    MODEL_REGISTRY,
};
