    ...
    void (async () => {
      if (!tauriAvailable) {
        ...
        loadError = {
          ...
          message:
            "L'application doit être lancée via `cargo run -p sobria-app` (ou `cargo tauri dev`). Le référentiel modèles consulte le `MODEL_REGISTRY` Rust local — pas de fetch externe."
        };
        return;
      }
      try {
...
<div class="canvas-inner">
  ...
  <section class="hero">
    <div class="hero-eyebrow">
      ...
      Module M9 · Catalogue transparent
    </div>
    <h1 class="hero-h1">
  ...
  {#if !bootstrapping && tauriAvailable && models.length > 0}
    <div class="layout">
      <div class="col-l">
