  ...
  const cards: DownloadCard[] = [
    {
      ...
      icon: '🪟',
      href: `${LATEST}/Sobr.ia_0.9.0_x64-setup.exe`,
    },
    {
      key: 'macos-arm',
      ...
      icon: '',
      href: `${LATEST}/Sobr.ia_0.9.0_aarch64.dmg`,
    },
    {
      key: 'macos-intel',
      label: 'macOS (Intel)',
      sublabel: '.dmg · x86_64',
      icon: '',
      href: `${LATEST}/Sobr.ia_0.9.0_x64.dmg`,
    },
    {
      key: 'linux',
      label: 'Linux',
      ...
      icon: '🐧',
      href: `${LATEST}/Sobr.ia_0.9.0_amd64.AppImage`,
    },
    {
      key: 'chrome',
      label: 'Chrome / Edge',
      ...
      icon: '🌐',
      href: `${LATEST}/sobria-extension-chrome-v0.9.0.zip`,
    },
    {
      key: 'firefox',
      label: 'Firefox',
      ...
      icon: '🦊',
      href: `${LATEST}/sobria-extension-firefox-v0.9.0.xpi`,
    },
    {
      key: 'android',
      label: 'Android / iOS',
